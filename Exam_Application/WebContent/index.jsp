...
<div style = "position:relative;left:250px;margin-left: 50%; height: 100px;">
<!-- Buttons -->
...
<button style="width:auto;">About Us</button>
</div>
...
<div id="login" class="modal">
  ...
  <form class="modal-content animate" action="/action_page.php" method="post">
    <div class="imgcontainer">
      ...
      <img src="images/userLogin.png" alt="Avatar" class="avatar">
    </div>
...
<div id="register" class="modal">
  ...
  <form class="modal-content animate" action="" method="post">
    ...
    <div class="container">
      ...
      <label for="yop"><b>Year Of Passing</b></label>
      <input type="text" placeholder="Year Of Passing" name="yop" required>  
